        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyProfilesId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOverViews", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResponsiblePersonJobTitle = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Industry = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    OfficialContactMethods = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserOverViewId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProfiles_UserOverViews_UserOverViewId",
                        column: x => x.UserOverViewId,
                        principalTable: "UserOverViews",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeadlineForApplications = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    JobLocation = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LanguageType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserProfileId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserProfileId = table.Column<int>(type: "int", nullable: false),
                    HasPassedExam = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobExams", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobExams_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "JobExamSubmissions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JobExamId = table.Column<int>(type: "int", nullable: false),
                    UserProfileId = table.Column<int>(type: "int", nullable: false),
                    SubmittedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobExamSubmissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobExamSubmissions_JobExams_JobExamId",
                        column: x => x.JobExamId,
                        principalTable: "JobExams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobExamSubmissions_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobQuestions_JobExams_JobExamId",
                        column: x => x.JobExamId,
                        principalTable: "JobExams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JobExamSubmissionId = table.Column<int>(type: "int", nullable: false),
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                    SelectedAnswer = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobExamAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobExamAnswers_JobExamSubmissions_JobExamSubmissionId",
                        column: x => x.JobExamSubmissionId,
                        principalTable: "JobExamSubmissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobExamAnswers_JobQuestions_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobExamAnswers_JobExamSubmissionId",
                table: "JobExamAnswers",
                column: "JobExamSubmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_JobExamAnswers_QuestionId",
                table: "JobExamAnswers",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_JobExams_JobId",
                table: "JobExams",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_JobExamSubmissions_JobExamId",
                table: "JobExamSubmissions",
                column: "JobExamId");

            migrationBuilder.CreateIndex(
                name: "IX_JobExamSubmissions_UserProfileId",
                table: "JobExamSubmissions",
                column: "UserProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_JobQuestions_JobExamId",
                table: "JobQuestions",
                column: "JobExamId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfiles_UserOverViewId",
                table: "UserProfiles",
                column: "UserOverViewId",
                unique: true,
                filter: "[UserOverViewId] IS NOT NULL");
        }
